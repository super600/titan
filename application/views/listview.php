...
<body class="c1">
<!-- Reset Stylesheet -->
<link rel="stylesheet" href="<?php echo base_url("res/admin/mag")?>/css/oo/reset_list.css" type="text/css" media="screen" />
<!-- Main Stylesheet -->
<link rel="stylesheet" href="<?php echo base_url("res/admin/mag")?>/css/oo/style_list.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo base_url("res/admin/mag")?>/js/oo/scripts/facebox.js"></script>
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div class="notification attention png_bg"> <a href="#" class="close"><img src="<?php echo base_url("res/admin/mag/css/images/icons/cross_grey_small.png");?>" title="Close this notification" alt="close" /></a>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="#" title="Edit"><img src="<?php echo base_url("res/admin/mag/css/images/icons/pencil.png");?>" alt="Edit" /></a> <a href="#" title="Delete"><img src="<?php echo base_url("res/admin/mag/css/images/icons/cross.png");?>" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="<?php echo base_url("res/admin/mag/css/images/icons/hammer_screwdriver.png");?>" alt="Edit Meta" /></a> </td>
              </tr>
              <tr>
                <td>
                  <input type="checkbox" />
