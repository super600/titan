...
<a href="<?php echo base_url("admin/newstype/add_")?>" class="button" style="float:right;">新闻列表</a>
          ...
          <table>
            ...
            <tbody>
              <?php foreach($query as $k => $v):?>
	                ...
	                <td><a href="#" title="title"><?php echo $v['type']?></a></td>
	                <td><?php echo date("Y-m-d",$v['inputtime']);?></td>
	                <td>
	                  <!-- Icons -->
	                  <a href="<?php echo base_url("admin/news/edit_")."/".$v['id'];?>" title="Edit"><img src="<?php echo base_url("res/admin/mag/css/images/icons/pencil.png");?>" alt="Edit" /></a> 
	                  <a href="<?php echo base_url("admin/news/del_")."/".$v['id'];?>" title="Delete"><img src="<?php echo base_url("res/admin/mag/css/images/icons/cross.png");?>" onclick="return confirm('确认删除？');" alt="Delete"/></a> 
