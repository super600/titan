...
class Checkcode {
	...
	function show() {//session_start();
		...
		//file_put_contents("bb.txt", $_SESSION[$this -> name].$_SESSION[$this -> name]);
		
		//file_put_contents("aaa.txt", $randcode);
		// $CI->session->set_userdata(array($this->name=>$randcode));
