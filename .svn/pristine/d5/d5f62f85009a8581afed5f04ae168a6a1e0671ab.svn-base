    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">案例列表</a></li>
          ...
          <table>
            ...
            <tbody>
              <?php foreach($query as $k => $v):?>
	                ...
	                <td>
	                  <!-- Icons -->
	                  <a href="<?php echo base_url("admin/projects/edit_")."/".$v['id'];?>" title="Edit"><img src="<?php echo base_url("res/admin/mag/css/images/icons/pencil.png");?>" alt="Edit" /></a> 
	                  <a href="<?php echo base_url("admin/projects/del_")."/".$v['id'];?>" title="Delete" onclick="return confirm('确认删除？')"><img src="<?php echo base_url("res/admin/mag/css/images/icons/cross.png");?>" alt="Delete" /></a> 
