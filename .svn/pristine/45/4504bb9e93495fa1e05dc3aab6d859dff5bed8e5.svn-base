    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">案例添加</a></li>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          <!-- This is the target div. id must match the href of this div's tab -->
			<?php if($dbtype=='save'):?>
			<?php $submit="提交信息";?>
			<form name="theform" action=" <?php echo base_url('admin/projects/save_'); ?> " onsubmit="return checkinfo();"  method="post">
			<?php endif;?>
			
			<input type="hidden" value="" />
			<?php if($dbtype=='update'):?>
			<?php $submit="更新信息";?>
            <form name="theform" action=" <?php echo base_url('admin/projects/edit_save')."/".$query[0]['id']; ?>" onsubmit="return checkinfo();" method="post">
			<?php endif;?>
			...
			<?php $this->load->view("tool/tag_types",array("title"=>"类型","field"=>"type","actiontype"=>"projects"))?>
