    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
			<?php if($dbtype=='save'):?>
			<?php $submit="提交信息";?>
			<form name="theform" action=" <?php echo base_url('admin/newstype/save_'); ?> " onsubmit="return checkinfo();"  method="post">
			<?php endif;?>
			
			<input type="hidden" value="" />
			<?php if($dbtype=='update'):?>
			<?php $submit="更新信息";?>
            <form name="theform" action=" <?php echo base_url('admin/newstype/edit_save')."/".$query[0]['id']; ?>" onsubmit="return checkinfo();" method="post">
			<?php endif;?>
