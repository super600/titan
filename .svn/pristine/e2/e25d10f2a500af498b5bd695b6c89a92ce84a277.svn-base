...
<a href="<?php echo base_url("admin/products/add_")?>" class="button" style="float:right;">产品添加</a>
	<div class="content-box">
	  ...
	  <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">产品列表</a></li>
          ...
          <table>
            ...
            <tbody>
              <?php foreach($query as $k => $v):?>
	                ...
	                <td>
	                  <!-- Icons -->
	                  <a href="<?php echo base_url("admin/products/edit_")."/".$v['id'];?>" title="Edit"><img src="<?php echo base_url("res/admin/mag/css/images/icons/pencil.png");?>" alt="Edit" /></a> 
	                  <a href="<?php echo base_url("admin/products/del_")."/".$v['id'];?>" title="Delete"><img src="<?php echo base_url("res/admin/mag/css/images/icons/cross.png");?>" onclick="return confirm('确认删除？');" alt="Delete"/></a> 
